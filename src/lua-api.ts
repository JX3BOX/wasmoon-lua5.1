import { EnvironmentVariables, LUA_GLOBALSINDEX, LUA_REGISTRYINDEX, LuaReturn, LuaState, LuaType } from './types'
import initWasmModule from '../build/lua.js'
...
export default class LuaApi {
    ...
    //public luaL_checkoption: (L: LuaState, arg: number, def: string | null, lst: unknown[]) => number
    ...
    constructor(module: LuaEmscriptenModule) {
        ...
        this.lua_pushcfunction = this.cwrap('lua_pushcfunction', null, ['number', 'number'])
