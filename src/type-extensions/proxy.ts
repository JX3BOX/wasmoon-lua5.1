...
class ProxyTypeExtension extends TypeExtension<any, ProxyDecorationOptions> {
    ...
    public constructor(thread: Global) {
        ...
        if (thread.luaApi.luaL_newmetatable(thread.address, this.name)) {
            ...
            thread.luaApi.lua_setfield(thread.address, metatableIndex, '__newindex')
            ...
            thread.luaApi.lua_setfield(thread.address, metatableIndex, '__len')
            ...
            thread.luaApi.lua_setfield(thread.address, metatableIndex, '__pairs')
            ...
            thread.luaApi.lua_setfield(thread.address, metatableIndex, '__call')
        }
